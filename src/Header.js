...
function Header () {
    ...
    useEffect(() =>{
      ...
      ScrollReveal().reveal(".btn-viewProjects", {origin: "top", distance:"100px", duration: 1000, delay:1000, reset:true});
      ScrollReveal().reveal(".btn-hireMe", {origin: "top", distance:"100px", duration: 1000, delay:1200, reset:true});
    }, []);
